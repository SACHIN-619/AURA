...
import { getSalons, getSalonById, getNearbySalons, getFeatured, getHubs, reportSalon, claimSalon, cancelClaim, proposeSalon } from '../controllers/salonController.js';
...
router.post('/propose',      requireAuth, proposeSalon);
